...
from graph.phase3.state import initial_top_state
...
def main():
    """Phase 3 entry point — a real top-level planner picks ONE query,
    ...
    try:
        result = pipeline.invoke(initial_top_state(SEARCH_QUERIES))
